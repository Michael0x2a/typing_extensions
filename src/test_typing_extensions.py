...
PY_VERSION = tuple(map(int, sys.argv[1].split('.')))
...
class GenericTests(BaseTestCase):
    ...
    def test_type_erasure_special(self):
        ...
        class MyDef(typing_extensions.DefaultDict[str, T]): ...
        self.assertIs(MyDef[int]().__class__, MyDef)
        self.assertIs(MyDef[int]().__orig_class__, MyDef[int])
        # ChainMap was added in 3.3
        if sys.version_info >= (3, 3):
            class MyChain(typing_extensions.ChainMap[str, T]): ...
...
class CollectionsAbcTests(BaseTestCase):
    ...
    def test_defaultdict_instantiation(self):
        self.assertIs(type(typing_extensions.DefaultDict()), collections.defaultdict)
        self.assertIs(type(typing_extensions.DefaultDict[KT, VT]()), collections.defaultdict)
        self.assertIs(type(typing_extensions.DefaultDict[str, int]()), collections.defaultdict)
